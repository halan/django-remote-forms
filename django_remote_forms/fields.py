...
class RemoteField(object):
    ...
    def as_dict(self):
        ...
        try:
            if hasattr(self.field.widget, 'as_dict'):
...
class RemoteArrayField(RemoteField):
    def as_dict(self):
        return super(RemoteArrayField, self).as_dict()
...
class RemoteNullBooleanField(RemoteBooleanField):
    def as_dict(self):
        field_dict = super(RemoteNullBooleanField, self).as_dict()
...
class RemoteHoursFormField(RemoteField):
    pass


class RemoteArrayChoiceField(RemoteChoiceField):
    def as_dict(self):
        return super(RemoteArrayChoiceField, self).as_dict()
